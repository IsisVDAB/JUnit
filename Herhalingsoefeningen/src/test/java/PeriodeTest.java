...
public class PeriodeTest {
    ...
    void vanMoetIngevuldZijn(){
        assertThatNullPointerException().isThrownBy(()-> new Periode(null, datum20190101));
    }

    @Test
    void totMoetIngevuldZijn(){
        assertThatNullPointerException().isThrownBy(()-> new Periode(datum20190101, null));
    }

    @Test
    void totMoetGroterOfGelijkZijnAanVan(){
        assertThatIllegalArgumentException().isThrownBy(() -> new Periode(datum20190109, datum20190101));
    }
    ...
    void eenPeriodeKomtNietNaEenPeriodeDieJongerIs() {
        assertThat(periode2.komtNa(periode1)).isFalse();
    }
    ...
    void eenPeriodeOverlaptMetEenPeriodeDieHelemaalInDeEerstePeriodeLigt() {
        assertThat(periode1.overlaptMet(new Periode(LocalDate.of(2019, 1, 2), LocalDate.of(2019, 1, 5)))).isTrue();
    }
